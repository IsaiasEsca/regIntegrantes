...
public class Calificaciones extends Fragment {
    ...
    ImageView imgHomeCalificacion;
    NavController navControllerCalif;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        navControllerCalif= Navigation.findNavController(view);
        imgHomeCalificacion=view.findViewById(R.id.regHomeCalif);
        imgHomeCalificacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                imgHomeCalificacionCali(v);
